        ...
        Container(
          ...
          child: Column(
              ...
              children: [
                ...
                /*Expanded(
                  ...
                  itemBuilder: (context, index) {
                    return ListTile(
                      ...
                      onTap: () {
                        // Perform desired action when a suggestion is tapped
                        _tagController.text = suggestions[index];
                      },
                    );
                  },
                )),*/
                  ...
                  child: Column(
                    children: List.generate(suggestions.length, (index) {
                      return Column(
                        ...
                        children: [
                          CupertinoButton(
                              color: Styles.takamakaColor.withOpacity(0.1),
                              alignment: Alignment.topLeft,
                              padding: const EdgeInsets.fromLTRB(16.0, 0.0, 16.0, 0.0),
                              borderRadius: BorderRadius.zero,
                              onPressed: () => {
                                _tagController.text = "",
                                updateTagsList(suggestions[index]),
                                setState(() => suggestions = []
                                )
                              },
                              child: Center(child: Text(suggestions[index], style: TextStyle(color: Colors.black38, fontWeight: FontWeight.w600)))),
                          SizedBox(height: 10)
                        ],
                      );
                ...
                const SizedBox(height: 30),
                CupertinoButton(
                    color: Globals.instance.restoreNewWalletsWords.length < 25
                        ? Styles.takamakaColor.withOpacity(0.5)
                        : Styles.takamakaColor,
                    onPressed: () => {
                          if (Globals.instance.restoreNewWalletsWords.length ==
                              25)
                            {
